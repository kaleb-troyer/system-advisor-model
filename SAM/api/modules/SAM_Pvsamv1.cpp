...
SAM_EXPORT void SAM_Pvsamv1_Load_grid_outage_aset(SAM_table ptr, double* arr, int length, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_Pvsamv1_BatteryDispatch_batt_dispatch_auto_can_curtailcharge_nset(SAM_table ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT void SAM_Pvsamv1_ElectricityRates_ur_nb_apply_credit_current_month_nset(SAM_table ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "ur_nb_apply_credit_current_month", number);
	});
}

SAM_EXPORT void SAM_Pvsamv1_ElectricityRates_ur_nb_credit_expire_nset(SAM_table ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT double SAM_Pvsamv1_SystemDesign_subarray1_slope_azm_nget(SAM_table ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "subarray1_slope_azm", &result))
		make_access_error("SAM_Pvsamv1", "subarray1_slope_azm");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_SystemDesign_subarray1_slope_tilt_nget(SAM_table ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "subarray1_slope_tilt", &result))
		make_access_error("SAM_Pvsamv1", "subarray1_slope_tilt");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_SystemDesign_subarray2_slope_azm_nget(SAM_table ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "subarray2_slope_azm", &result))
		make_access_error("SAM_Pvsamv1", "subarray2_slope_azm");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_SystemDesign_subarray2_slope_tilt_nget(SAM_table ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "subarray2_slope_tilt", &result))
		make_access_error("SAM_Pvsamv1", "subarray2_slope_tilt");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_SystemDesign_subarray3_slope_azm_nget(SAM_table ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "subarray3_slope_azm", &result))
		make_access_error("SAM_Pvsamv1", "subarray3_slope_azm");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_SystemDesign_subarray3_slope_tilt_nget(SAM_table ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "subarray3_slope_tilt", &result))
		make_access_error("SAM_Pvsamv1", "subarray3_slope_tilt");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_SystemDesign_subarray4_slope_azm_nget(SAM_table ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "subarray4_slope_azm", &result))
		make_access_error("SAM_Pvsamv1", "subarray4_slope_azm");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_SystemDesign_subarray4_slope_tilt_nget(SAM_table ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "subarray4_slope_tilt", &result))
		make_access_error("SAM_Pvsamv1", "subarray4_slope_tilt");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatterySystem_en_standalone_batt_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "en_standalone_batt", &result))
		make_access_error("SAM_Pvsamv1", "en_standalone_batt");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Load_crit_load_escalation_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "crit_load_escalation");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Load_grid_outage_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "grid_outage");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_Load_run_resiliency_calcs_nget(SAM_table ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
...
SAM_EXPORT double SAM_Pvsamv1_BatteryCell_batt_Vcut_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_Vcut", &result))
		make_access_error("SAM_Pvsamv1", "batt_Vcut");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatteryCell_batt_life_model_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_life_model", &result))
		make_access_error("SAM_Pvsamv1", "batt_life_model");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatteryCell_batt_minimum_outage_SOC_nget(SAM_table ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "batt_minimum_outage_SOC", &result))
		make_access_error("SAM_Pvsamv1", "batt_minimum_outage_SOC");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatteryDispatch_batt_dispatch_auto_btm_can_discharge_to_grid_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_dispatch_auto_btm_can_discharge_to_grid", &result))
		make_access_error("SAM_Pvsamv1", "batt_dispatch_auto_btm_can_discharge_to_grid");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatteryDispatch_batt_dispatch_auto_can_curtailcharge_nget(SAM_table ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "batt_dispatch_auto_can_curtailcharge", &result))
		make_access_error("SAM_Pvsamv1", "batt_dispatch_auto_can_curtailcharge");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatteryDispatch_batt_dispatch_charge_only_system_exceeds_load_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_dispatch_charge_only_system_exceeds_load", &result))
		make_access_error("SAM_Pvsamv1", "batt_dispatch_charge_only_system_exceeds_load");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatteryDispatch_batt_dispatch_discharge_only_load_exceeds_system_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_dispatch_discharge_only_load_exceeds_system", &result))
		make_access_error("SAM_Pvsamv1", "batt_dispatch_discharge_only_load_exceeds_system");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatteryDispatch_batt_dispatch_pvs_ac_lb_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_dispatch_pvs_ac_lb", &result))
		make_access_error("SAM_Pvsamv1", "batt_dispatch_pvs_ac_lb");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatteryDispatch_batt_dispatch_pvs_ac_lb_enable_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_dispatch_pvs_ac_lb_enable", &result))
		make_access_error("SAM_Pvsamv1", "batt_dispatch_pvs_ac_lb_enable");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatteryDispatch_batt_dispatch_pvs_ac_ub_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_dispatch_pvs_ac_ub", &result))
		make_access_error("SAM_Pvsamv1", "batt_dispatch_pvs_ac_ub");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatteryDispatch_batt_dispatch_pvs_ac_ub_enable_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_dispatch_pvs_ac_ub_enable", &result))
		make_access_error("SAM_Pvsamv1", "batt_dispatch_pvs_ac_ub_enable");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatteryDispatch_batt_dispatch_pvs_curtail_as_control_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_dispatch_pvs_curtail_as_control", &result))
		make_access_error("SAM_Pvsamv1", "batt_dispatch_pvs_curtail_as_control");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatteryDispatch_batt_dispatch_pvs_curtail_if_violation_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_dispatch_pvs_curtail_if_violation", &result))
		make_access_error("SAM_Pvsamv1", "batt_dispatch_pvs_curtail_if_violation");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatteryDispatch_batt_dispatch_pvs_forecast_shift_periods_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_dispatch_pvs_forecast_shift_periods", &result))
		make_access_error("SAM_Pvsamv1", "batt_dispatch_pvs_forecast_shift_periods");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatteryDispatch_batt_dispatch_pvs_kf_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_dispatch_pvs_kf", &result))
		make_access_error("SAM_Pvsamv1", "batt_dispatch_pvs_kf");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatteryDispatch_batt_dispatch_pvs_ki_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_dispatch_pvs_ki", &result))
		make_access_error("SAM_Pvsamv1", "batt_dispatch_pvs_ki");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatteryDispatch_batt_dispatch_pvs_kp_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_dispatch_pvs_kp", &result))
		make_access_error("SAM_Pvsamv1", "batt_dispatch_pvs_kp");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatteryDispatch_batt_dispatch_pvs_max_ramp_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_dispatch_pvs_max_ramp", &result))
		make_access_error("SAM_Pvsamv1", "batt_dispatch_pvs_max_ramp");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatteryDispatch_batt_dispatch_pvs_nameplate_ac_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_dispatch_pvs_nameplate_ac", &result))
		make_access_error("SAM_Pvsamv1", "batt_dispatch_pvs_nameplate_ac");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatteryDispatch_batt_dispatch_pvs_short_forecast_enable_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_dispatch_pvs_short_forecast_enable", &result))
		make_access_error("SAM_Pvsamv1", "batt_dispatch_pvs_short_forecast_enable");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatteryDispatch_batt_dispatch_pvs_soc_rest_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_dispatch_pvs_soc_rest", &result))
		make_access_error("SAM_Pvsamv1", "batt_dispatch_pvs_soc_rest");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_BatteryDispatch_batt_dispatch_pvs_timestep_multiplier_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_dispatch_pvs_timestep_multiplier", &result))
		make_access_error("SAM_Pvsamv1", "batt_dispatch_pvs_timestep_multiplier");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_BatteryDispatch_dispatch_manual_btm_discharge_to_grid_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "dispatch_manual_btm_discharge_to_grid");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_ElectricityRates_ur_nb_apply_credit_current_month_nget(SAM_table ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "ur_nb_apply_credit_current_month", &result))
		make_access_error("SAM_Pvsamv1", "ur_nb_apply_credit_current_month");
	});
	return result;
}

SAM_EXPORT double SAM_Pvsamv1_ElectricityRates_ur_nb_credit_expire_nget(SAM_table ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "ur_nb_credit_expire", &result))
		make_access_error("SAM_Pvsamv1", "ur_nb_credit_expire");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_ElectricityRates_ur_yearzero_usage_peaks_aget(SAM_table ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
	result = ssc_data_get_array(ptr, "ur_yearzero_usage_peaks", length);
	if (!result)
		make_access_error("SAM_Pvsamv1", "ur_yearzero_usage_peaks");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_GridLimits_enable_interconnection_limit_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "enable_interconnection_limit", &result))
		make_access_error("SAM_Pvsamv1", "enable_interconnection_limit");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_GridLimits_grid_curtailment_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "grid_curtailment");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_HybridCosts_degradation_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "degradation");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_HybridCosts_land_area_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "land_area", &result))
		make_access_error("SAM_Pvsamv1", "land_area");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_HybridCosts_om_capacity_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "om_capacity");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_HybridCosts_om_capacity_escal_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "om_capacity_escal", &result))
		make_access_error("SAM_Pvsamv1", "om_capacity_escal");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_HybridCosts_om_fixed_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "om_fixed");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_HybridCosts_om_fixed_escal_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "om_fixed_escal", &result))
		make_access_error("SAM_Pvsamv1", "om_fixed_escal");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_HybridCosts_om_land_lease_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "om_land_lease");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_HybridCosts_om_land_lease_escal_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "om_land_lease_escal", &result))
		make_access_error("SAM_Pvsamv1", "om_land_lease_escal");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_HybridCosts_total_installed_cost_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "total_installed_cost", &result))
		make_access_error("SAM_Pvsamv1", "total_installed_cost");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_ac_perf_adj_loss_aget(SAM_table ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
	result = ssc_data_get_array(ptr, "ac_perf_adj_loss", length);
	if (!result)
		make_access_error("SAM_Pvsamv1", "ac_perf_adj_loss");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_Outputs_annual_crit_load_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "annual_crit_load", &result))
		make_access_error("SAM_Pvsamv1", "annual_crit_load");
	});
	return result;
}

SAM_EXPORT double SAM_Pvsamv1_Outputs_annual_crit_load_unmet_nget(SAM_table ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "annual_crit_load_unmet", &result))
		make_access_error("SAM_Pvsamv1", "annual_crit_load_unmet");
	});
	return result;
}

SAM_EXPORT double SAM_Pvsamv1_Outputs_annual_crit_load_unmet_percentage_nget(SAM_table ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "annual_crit_load_unmet_percentage", &result))
		make_access_error("SAM_Pvsamv1", "annual_crit_load_unmet_percentage");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_annual_energy_distribution_time_mget(SAM_table ptr, int* nrows, int* ncols, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "annual_energy_distribution_time");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_Outputs_annual_outage_losses_unmet_nget(SAM_table ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "annual_outage_losses_unmet", &result))
		make_access_error("SAM_Pvsamv1", "annual_outage_losses_unmet");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_batt_pvs_PV_ramp_interval_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "batt_pvs_PV_ramp_interval");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_batt_pvs_P_pv_ac_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "batt_pvs_P_pv_ac");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_batt_pvs_battpower_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "batt_pvs_battpower");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_batt_pvs_battsoc_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "batt_pvs_battsoc");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_batt_pvs_curtail_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "batt_pvs_curtail");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_Outputs_batt_pvs_energy_to_grid_percent_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_pvs_energy_to_grid_percent", &result))
		make_access_error("SAM_Pvsamv1", "batt_pvs_energy_to_grid_percent");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_Outputs_batt_pvs_energy_to_grid_percent_sam_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_pvs_energy_to_grid_percent_sam", &result))
		make_access_error("SAM_Pvsamv1", "batt_pvs_energy_to_grid_percent_sam");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_batt_pvs_forecast_pv_energy_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "batt_pvs_forecast_pv_energy");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_batt_pvs_outpower_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "batt_pvs_outpower");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_Outputs_batt_pvs_violation_count_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_pvs_violation_count", &result))
		make_access_error("SAM_Pvsamv1", "batt_pvs_violation_count");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_batt_pvs_violation_list_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "batt_pvs_violation_list");
	});
	return result;
}
...
SAM_EXPORT double SAM_Pvsamv1_Outputs_batt_pvs_violation_percent_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "batt_pvs_violation_percent", &result))
		make_access_error("SAM_Pvsamv1", "batt_pvs_violation_percent");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_batt_to_system_load_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "batt_to_system_load");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_cf_battery_replacement_cost_schedule_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "cf_battery_replacement_cost_schedule");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_cf_energy_net_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "cf_energy_net");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_cf_om_capacity_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "cf_om_capacity");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_cf_om_fixed_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "cf_om_fixed");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_cf_om_fuel_cost_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "cf_om_fuel_cost");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_cf_om_land_lease_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "cf_om_land_lease");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_crit_load_unmet_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "crit_load_unmet");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_interconnection_loss_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "interconnection_loss");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_monthly_batt_to_system_load_aget(SAM_table ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
	result = ssc_data_get_array(ptr, "monthly_batt_to_system_load", length);
	if (!result)
		make_access_error("SAM_Pvsamv1", "monthly_batt_to_system_load");
	});
	return result;
}

SAM_EXPORT double* SAM_Pvsamv1_Outputs_monthly_crit_load_aget(SAM_table ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
	result = ssc_data_get_array(ptr, "monthly_crit_load", length);
	if (!result)
		make_access_error("SAM_Pvsamv1", "monthly_crit_load");
	});
	return result;
}

SAM_EXPORT double* SAM_Pvsamv1_Outputs_monthly_crit_load_unmet_aget(SAM_table ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
	result = ssc_data_get_array(ptr, "monthly_crit_load_unmet", length);
	if (!result)
		make_access_error("SAM_Pvsamv1", "monthly_crit_load_unmet");
	});
	return result;
}

SAM_EXPORT double* SAM_Pvsamv1_Outputs_monthly_crit_load_unmet_percentage_aget(SAM_table ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
	result = ssc_data_get_array(ptr, "monthly_crit_load_unmet_percentage", length);
	if (!result)
		make_access_error("SAM_Pvsamv1", "monthly_crit_load_unmet_percentage");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_monthly_interconnection_loss_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "monthly_interconnection_loss");
	});
	return result;
}

SAM_EXPORT double* SAM_Pvsamv1_Outputs_monthly_outage_losses_unmet_aget(SAM_table ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
	result = ssc_data_get_array(ptr, "monthly_outage_losses_unmet", length);
	if (!result)
		make_access_error("SAM_Pvsamv1", "monthly_outage_losses_unmet");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Pvsamv1_Outputs_outage_losses_unmet_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Pvsamv1", "outage_losses_unmet");
	});
	return result;
}
