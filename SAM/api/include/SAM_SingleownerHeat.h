#ifndef SAM_SINGLEOWNERHEAT_H_
#define SAM_SINGLEOWNERHEAT_H_
...
extern "C"
{
	...
	//
	// SingleownerHeat Technology Model
	//

	/** 
	 * Create a SingleownerHeat variable table.
	 * @param def: the set of financial model-dependent defaults to use (None, Residential, ...)
	 * @param[in,out] err: a pointer to an error object
	 */

	SAM_EXPORT typedef void * SAM_SingleownerHeat;
	...
	/**
	 * Set gen: Net power to or from the grid [kW]
	 * options: None
	 * constraints: None
	 * required if: *
	 */
